...
La idea de esta vecindad es ver que, al quitar un nodo de la clique y crear una nueva con los nodos restantes y un nodo externo, es posible formar nuevas soluciones que alcancen una frontera mayor a la obtenida. Para encontrar el par de nodos(uno interno a la clique y otro externo) que mejoren la clique, lo que vamos a hacer es, recorrer los nodos internos y por cada nodo buscar en los ejes externos cuanto nos mejora la solución si los intercambiamos.
